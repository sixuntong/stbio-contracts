...
namespace eosiosystem {
   ...
   class [[eosio::contract("eosio.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr eosio::name token_account{"stb.token"_n};
         static constexpr eosio::name ram_account{"stb.ram"_n};
         static constexpr eosio::name ramfee_account{"stb.ramfee"_n};
         static constexpr eosio::name stake_account{"stb.stake"_n};
         static constexpr eosio::name bpay_account{"stb.bpay"_n};
         static constexpr eosio::name vpay_account{"stb.vpay"_n};
         static constexpr eosio::name names_account{"stb.names"_n};
         static constexpr eosio::name saving_account{"stb.saving"_n};
         static constexpr eosio::name rex_account{"stb.rex"_n};
         static constexpr eosio::name null_account{"stb.null"_n};
         ...
         static symbol get_core_symbol( name system_account = "stbio"_n ) {
